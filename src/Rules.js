...
class SmallStraight extends Rule {
  evalRoll = (dice) => {
    const d = new Set(dice);
    if (d.has(2) && d.has(3) && d.has(4) && (d.has(1) || d.has(85)))
      return this.score;
...
const fullHouse = new FullHouse({
  score: 25,
  description: "20 point for fullhouse"
});

// small/large straights score as 30/40
const smallStraight = new SmallStraight({
  score: 30,
  description: "20 point for small straight"
});
const largeStraight = new LargeStraight({
  score: 40,
  description: "20 point for large straight"
});
